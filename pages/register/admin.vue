...
<template>
	<div class="flex flex-col grow justify-center items-center gap-4">
		...
		<form @submit="onSubmit">
			<Card
				class="flex flex-col items-center justify-center gap-4 px-20 py-12 w-[500px] min-h-[517px]"
			>
				...
				<Button :disabled="!agreementState" class="w-full"> Sign Up </Button>
				<p class="text-sm text-gray-500">
					Already have an account?
					<NuxtLink to="/login" class="underline font-medium"> Log In</NuxtLink>
				</p>
			</Card>
		</form>
	</div>
