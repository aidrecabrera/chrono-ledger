...
const isDataEmpty = () => {
  return !pending && archived_ao_management_data?.value?.length === 0;
}
...
<template>
  <div class="p-8">
    <Transition mode="out-in" name="fade">
      <div v-if="isDataEmpty()" class="flex flex-col min-w-full gap-4 pt-8 justify-center items-center">
        <div>
      ...
      <div v-else-if="isLoading()" class="flex flex-col min-w-full gap-2 pt-8 justify-center items-center">
